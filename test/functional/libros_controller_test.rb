...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { autor: @libro.autor, descripcion: @libro.descripcion, isbn: @libro.isbn, titulo: @libro.titulo }
    end
  ...
  test "should update libro" do
    put :update, id: @libro, libro: { autor: @libro.autor, descripcion: @libro.descripcion, isbn: @libro.isbn, titulo: @libro.titulo }
    assert_redirected_to libro_path(assigns(:libro))
  end
